...
public class Lexer {
    ...
    public Lexer (String fileName) { // source filename
        try {
            input = new BufferedReader (new FileReader(fileName)); //put them into the bufferreader
        }
    ...
    private char nextChar() { // Return next char
        ...
        if (col >= line.length()) {
            ...
            if (line == null) // at end of file
                line = "" + eofCh; //append eofCh so that when we get to the end of file, we can detect them
            else {
    ...
    public Token next( ) { // Return next token
        do {
            ...
            /*******Beginning student exercise part**************/
            case '-' : ch = nextChar();
    ...
    protected Token chkOpt(char c, Token one, Token two) {
    	if(c == '='){
    		ch = nextChar();
    		switch(ch) {
    			case '=':
    ...
    public void error (String msg) {
        ...
        System.err.println("If there is error. Error: column " + col + " " + msg);
        System.exit(1);
    }
